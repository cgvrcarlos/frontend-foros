...
const base = 'inline-flex items-center justify-center gap-2 rounded-lg font-semibold border-2 border-teal-accent text-teal-accent bg-transparent hover:bg-teal-accent hover:text-white disabled:opacity-60 disabled:cursor-not-allowed focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-teal-accent focus-visible:ring-offset-2 transition';

export function SecondaryButton({ children, onClick, href, disabled, type = 'button', size = 'md', className = '', 'aria-label': ariaLabel }: ButtonProps) {
